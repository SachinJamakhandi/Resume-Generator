...
<head>
  ...
  <style>
        body
        {
            background: url('https://www.teahub.io/photos/full/13-137497_this-high-quality-free-png-image-without-any.jpg');
...
<div class="container d-flex justify-content-center mb-4">
      <button type="submit" onclick="print()" class="btn btn-primary bg-dark text-white rounded-pill mt-2" style="float: right;">Print</button>
      <button type="sumbit" onclick="gohome()" class="btn btn-primary bg-dark text-white rounded-pill mt-2" style="float: right;">Home</button>
</div>
