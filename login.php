...
<html lang="en">
  <head>
    ...
    <style>
        body
        {
            background: url('https://cdn.wallpapersafari.com/70/61/Vvu2q9.jpg');
...
<form action="" method="post">
  ...
  <button type="submit" class="btn btn-primary bg-dark text-white rounded-pill mt-2">Login</button>
</form>
</div>
